        ...
        <ScrollView style={styles.container} contentContainerStyle={styles.content}>
            ...
            <View style={styles.section}>
                ...
                <Text style={styles.text}>
                    Ao utilizar a plataforma Kwick, o utilizador concorda em cumprir estes Termos e Condições. 
            ...
            <View style={styles.section}>
                ...
                <Text style={styles.text}>
                    O Kwick é uma plataforma que conecta prestadores de serviços (Trabalhadores) e clientes (Empregadores) em Moçambique. 
                    O Kwick não é uma agência de emprego e não se responsabiliza pelas negociações diretas entre as partes.
                </Text>
            </View>
            ...
            <View style={styles.section}>
                ...
                <Text style={styles.text}>
                    Todo o conteúdo disponível na plataforma é propriedade do Kwick ou dos seus licenciadores.
                </Text>
            </View>
